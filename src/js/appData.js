...
// ==================== STEP 5-1: 嘉義編（名物・観光・日帰りトリップ・豆知識）確認クイズ (全10問) ====================
window.VOWELS_QUIZ_QUESTIONS_5_1 = [
  ...
  { id: 2, type: "audio", targetSymbol: "奮起湖", speechTarget: "奮起湖", prompt: "再生された阿里山森林鉄道の中継点で、鉄路弁当やドーナツが有名な日帰り名所はどれ？", options: ["奮起湖", "阿里山", "關子嶺", "東石"] },
  { id: 3, type: "zhuyin-to-word", targetSymbol: "魚頭の土鍋煮込み (嘉義名物大鍋)", speechTarget: "砂鍋魚頭", prompt: "注音「ㄕㄚ ㄍㄨㄛ ㄩˊ ㄊㄡˊ (砂鍋魚頭)」に対応する嘉義グルメはどれ？", options: ["魚頭の土鍋煮込み (嘉義名物大鍋)", "七面鳥肉ご飯", "スクエアパイ菓子", "豆乳豆花"] },
  { id: 4, type: "zhuyin-to-word", targetSymbol: "泥温泉 (嘉義からバス45分の名湯)", speechTarget: "泥漿溫泉", prompt: "關子嶺で有名な「ㄋㄧˊ ㄐㄧㄤ ㄨㄣ ㄑㄩㄢˊ (泥漿溫泉)」の意味はどれ？", options: ["泥温泉 (嘉義からバス45分の名湯)", "炭酸泉", "硫黄泉", "冷泉"] },
  ...
  { id: 7, type: "audio", targetSymbol: "檜意森活村", speechTarget: "檜意森活村", prompt: "再生されたヒノキ木造家屋群が立ち並ぶ嘉義市内の人気観光名所はどれ？", options: ["檜意森活村", "故宮南院", "文化路夜市", "嘉義市立美術館"] },
  { id: 8, type: "zhuyin-to-word", targetSymbol: "故宮南院 (アジア芸術の殿堂・水上博物館)", speechTarget: "故宮南院", prompt: "嘉義高鐵からすぐの近郊名所「ㄍㄨˋ ㄍㄨㄥ ㄋㄢˊ ㄩㄢˋ (故宮南院)」はどれ？", options: ["故宮南院 (アジア芸術の殿堂・水上博物館)", "國立歷史博物館", "奇美博物館", "高雄市立美術館"] },
...
window.VOWELS_QUIZ_QUESTIONS_5_3 = window.VOWELS_QUIZ_QUESTIONS_5_1;
window.VOWELS_QUIZ_QUESTIONS_5_5 = window.VOWELS_QUIZ_QUESTIONS_5_4;
