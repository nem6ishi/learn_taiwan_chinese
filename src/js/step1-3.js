...
(function() {
  ...
  function setupQuizListeners() {
    ...
    const runQuiz = () => {
      if (window.QuizEngine && window.VOWELS_QUIZ_QUESTIONS_2) {
        window.QuizEngine.startQuiz(window.VOWELS_QUIZ_QUESTIONS_2, {
          stepTitle: "1-3 舌尖音＋二重母音確認クイズ",
          nextStepUrl: "step-1-4.html",
