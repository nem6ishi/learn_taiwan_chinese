...
(function(window) {
  ...
  const DEFAULT_REVIEW_WORDS = [
    {
      ...
      zhuyin: 'ㄒㄧㄥˊ ㄊㄧㄢ ㄍㄨㄥ',
      pinyin: 'xíngtiāngōng',
      meaning: '行天宮 (シンティエンゴン / 台北で最も参拝客が多い関羽を祀る道教寺院)',
      example: '我們明天去行天宮拜拜。 (私たちは明日、行天宮へお参りに行きます)',
      column: {
        title: '⛩️ 商売繁盛と勝負の神様「関羽」を祀る台北の名刹・行天宮！',
        content: '• 三国志の英雄・関聖帝君（関羽）を主神として祀る台北屈指のパワースポット。<br>• 商売繁盛や学業・勝負運のご利益で名高く、青い法衣を着た女性ボランティア「効労生」による無料のお祓い「<strong>收驚 (ショウジン)</strong>」に連日長蛇の列ができます。MRT中和新蘆線に「行天宮站」があります。'
      },
      createdAt: 1789144060000 // 2026/09/12 01:28
    },
    {
      traditional: '睡覺',
      zhuyin: 'ㄕㄨㄟˋ ㄐㄧㄠˋ',
      pinyin: 'shuìjiào',
      meaning: '寝る / 眠る / 睡眠をとる',
      example: '我太累了，想早點睡覺。 (とても疲れたので、早く寝たいです)',
      column: {
        title: '😴 「睡（眠る）」＋「覺（目を覚ます・感覚）」！',
        content: '• 「覺」は「感覚 (gǎnjué)」では「jué」ですが、「寝る」のときは「jiào (ㄐㄧㄠˋ)」と発音する多音字です。<br>• 離合詞（動詞＋目的語）なので、「睡個好覺（ぐっすりよく眠る）」「睡了八個小時（8時間寝た）」のように間に語句を挟むことができます。「快去睡覺！（早く寝なさい！）」は親やパートナーからの日常フレーズです。'
      },
      createdAt: 1789144059000 // 2026/09/12 01:28
    },
    {
      traditional: '打工',
      zhuyin: 'ㄉㄚˇ ㄍㄨㄥ',
      pinyin: 'dǎgōng',
      meaning: 'アルバイトをする / バイト / 働く',
      example: '他放學後去飲料店打工。 (彼は放課後、ドリンクスタンドへバイトに行きます)',
      column: {
        title: '💼 台湾の若者のアルバイト事情と「打工換宿」！',
        content: '• <strong>打</strong>（働く・従事する）＋ <strong>工</strong>（仕事・労働）。学生のアルバイトや副業を指します（パートタイマー＝工讀生）。<br>• 台湾では夏休みなどに民宿やカフェでお手伝いをして宿泊費を浮かす「<strong>打工換宿</strong>（ワーキングステイ）」が学生やバックパッカーの間で大流行しています。'
      },
      createdAt: 1789144058000 // 2026/09/12 01:28
    },
    {
      traditional: '高爾夫球',
      zhuyin: 'ㄍㄠ ㄦˇ ㄈㄨ ㄑㄧㄡˊ',
      pinyin: "gāo'ěrfūqiú",
      meaning: 'ゴルフ (球技)',
      example: '爸爸週末喜歡打高爾夫球。 (父は週末にゴルフをするのが好きです)',
      column: {
        title: '⛳ 英語の「Golf」の音訳＋球技の「球」！',
        content: '• 英語の Golf を音訳した「<strong>高爾夫 (ㄍㄠ ㄦˇ ㄈㄨ)</strong>」に球技を表す「球 (ㄑㄧㄡˊ)」を付けた名称です。<br>• 球技をする動詞は「<strong>打 (ㄉㄚˇ)</strong>」を使います（打高爾夫球＝ゴルフをする、打網球＝テニスをする、打籃球＝バスケをする）。台湾は温暖な気候で、淡水や林口などに美しいゴルフ場が点在しています。'
      },
      createdAt: 1789144057000 // 2026/09/12 01:28
    },
    {
      traditional: '週末',
      zhuyin: 'ㄓㄡ ㄇㄛˋ',
      pinyin: 'zhōumò',
      meaning: '週末 / ウィークエンド',
      example: '祝你有個愉快的週末！ (楽しい週末をお過ごしください！)',
      column: {
        title: '📅 「週（1週間）」＋「末（終わり）」！定番の週末挨拶',
        content: '• <strong>週 (ㄓㄡ)</strong>（1週間）の <strong>末 (ㄇㄛˋ)</strong>（終わり＝土曜日・日曜日）。<br>• 金曜日の夕方やメッセージの結びで「<strong>週末愉快！ (ㄓㄡ ㄇㄛˋ ㄩˊ ㄎㄨㄞˋ / 良い週末を！)</strong>」と送り合うのが台湾のビジネスや友人同士の定番マナーです。'
      },
      createdAt: 1789144056000 // 2026/09/12 01:28
    },
    {
      traditional: '計畫',
      zhuyin: 'ㄐㄧˋ ㄏㄨㄚˋ',
      pinyin: 'jìhuà',
      meaning: '予定 / 計画 / プラン / スケジュール (〜する予定である)',
      example: '你週末有什麼計畫？ (週末に何か予定はありますか？)',
      column: {
        title: '📝 台湾の公文書・標準表記「計畫」と日常の「打算」！',
        content: '• 台湾では政府公認の標準字体として「<strong>計畫</strong>」と「畫」を使うのが伝統的・公的によく用いられます（「計劃」も同義で併用されます）。名詞「予定・計画」としても動詞「計画する」としても使えます。<br>• 日常会話で「〜するつもり・予定」と言うときは「<strong>打算 (ㄉㄚˇ ㄙㄨㄢˋ / dǎsuàn)</strong>」も非常によく使われます（例：你週末打算做什麼？）。'
      },
      createdAt: 1789144055000 // 2026/09/12 01:28
    },
    {
      traditional: '德文',
      zhuyin: 'ㄉㄜˊ ㄨㄣˊ',
      pinyin: 'déwén',
      meaning: 'ドイツ語',
      example: '我想學德文和法文。 (私はドイツ語とフランス語を勉強したいです)',
      column: {
        title: '💡 台湾華語における言語名の表し方（〜文 vs 〜語）',
        content: '• <strong>德文 (ㄉㄜˊ ㄨㄣˊ)</strong>: 「德國 (Déguó / ドイツ)」の「德」＋「文 (言語・文字)」。<br>• 台湾では外国語を呼ぶ際、「英文 (英語)」「日文 (日本語)」「法文 (フランス語)」「德文 (ドイツ語)」のように「〜文」と言うのが一般的です（「德語」も通じますが、日常会話では「德文」が非常によく使われます）。'
      },
      createdAt: 1789143958000 // 2026/09/12 01:26
    },
    {
      traditional: '雜誌',
      zhuyin: 'ㄗㄚˊ ㄓˋ',
      pinyin: 'zázhì',
      meaning: '雑誌 / マガジン',
      example: '我想買這本時尚雜誌。 (このファッション雑誌を買いたいです)',
      column: {
        title: '📚 台湾の書店文化と雑誌の量詞「本 (ㄅㄣˇ)」',
        content: '• <strong>雜 (ㄗㄚˊ)</strong>（様々・多彩な）＋ <strong>誌 (ㄓˋ)</strong>（記録・記したもの）。多彩な記事を集めた出版物のこと。<br>• 雑誌や本を数えるときは量詞<strong>「本 (ㄅㄣˇ)」</strong>を使います（一本雜誌＝1冊の雑誌）。台湾には誠品書店（Eslite）をはじめ、深夜まで開いているお洒落な大型書店が多く、雑誌コーナーで立ち読み（看書）を楽しむ文化が根付いています。'
      },
      createdAt: 1789143957000 // 2026/09/12 01:26
    },
    {
      traditional: '桌子',
      zhuyin: 'ㄓㄨㄛ ㄗ˙',
      pinyin: 'zhuōzi',
      meaning: '机 / テーブル / デスク',
      example: '桌子上有杯熱咖啡。 (机の上に温かいコーヒーが一杯あります)',
      column: {
        title: '💡 「桌子」と机を数える量詞「張 (ㄓㄤ)」',
        content: '• <strong>桌 (ㄓㄨㄛ)</strong> は平らな板を支えた台・机のことで、軽声の接尾辞「子 (ㄗ˙)」が付きます。<br>• 机やテーブル、紙など「平らな面を持つもの」を数える量詞は<strong>「張 (ㄓㄤ)」</strong>を使います（一張桌子＝1台の机）。台湾の食堂では「這張桌子有人嗎？（このテーブルは空いてますか？）」と店員さんによく尋ねます。'
      },
      createdAt: 1789143956000 // 2026/09/12 01:26
    },
    {
      traditional: '木頭',
      zhuyin: 'ㄇㄨˋ ㄊㄡ˙',
      pinyin: 'mùtou',
      meaning: '木材 / 木 / 丸太 (比喩: 鈍感な人・融通が利かない人)',
      example: '這張椅子是用木頭做的。 (この椅子は木で作られています)',
      column: {
        title: '🪵 素材としての木材と、台湾の日常スラング「木頭」',
        content: '• <strong>木 (ㄇㄨˋ)</strong>＋接尾辞 <strong>頭 (ㄊㄡ˙)</strong> で「木材・角材・丸太」を表します。<br>• 台湾の日常会話やドラマでは、人の気持ちに鈍感な人や融通が利かない人のことを「<strong>木頭 (mùtou)</strong>」や「木頭人（動かない木の人＝だるまさんが転んだの鬼/鈍感な人）」とユーモアを込めて呼ぶことがあります（例：他真是個大木頭！＝彼ったら本当に鈍感なんだから！）。'
      },
      createdAt: 1789143955000 // 2026/09/12 01:26
    },
    {
      traditional: '釋迦',
      zhuyin: 'ㄕˋ ㄐㄧㄚ',
      pinyin: 'shìjiā',
      meaning: '釈迦頭 (シャカトウ / バンレイシ。台湾名物の甘い高級フルーツ)',
      example: '台東的釋迦非常甜非常好吃。 (台東の釈迦頭はとても甘くて美味しいです)',
      column: {
        title: '🍈 台湾特産フルーツの王様「釋迦（シャカ頭）」！',
        content: '• 表面のゴツゴツした凹凸がお釈迦様の螺髪（らほつ・頭の巻き毛）に似ていることから「<strong>釋迦</strong>（または釋迦頭）」と名付けられました。<br>• 台湾東部の台東県が一大産地！驚くほどクリーミーで練乳のように濃厚な甘みが特徴です。近年はパイナップルと掛け合わせた「<strong>鳳梨釋迦 (アテモヤ)</strong>」も台湾土産や贈答用として絶大な人気を誇ります。'
      },
      createdAt: 1789143954000 // 2026/09/12 01:26
    },
    {
      traditional: '襪子',
      zhuyin: 'ㄨㄚˋ ㄗ˙',
      pinyin: 'wàzi',
      meaning: '靴下 / ソックス',
      example: '他買了一雙新襪子。 (彼は新しい靴下を1足買いました)',
      column: {
        title: '🧦 靴下を数える量詞「雙 (ㄕㄨㄤ)」と「隻 (ㄓ)」',
        content: '• 2つ揃った1組（1足）の靴下は量詞<strong>「雙 (ㄕㄨㄤ)」</strong>を使い「一雙襪子」と言います。<br>• 片方だけを数える時は動物や対の片方に使う量詞<strong>「隻 (ㄓ)」</strong>を使って「一隻襪子（片方の靴下）」と呼びます（例：我少了一隻襪子！＝靴下が片方見つからない！）。'
      },
      createdAt: 1789143953000 // 2026/09/12 01:26
    },
    {
      traditional: '件',
      zhuyin: 'ㄐㄧㄢˋ',
      pinyin: 'jiàn',
      meaning: '〜着 (服を数える量詞) / 〜件 (用事・出来事を数える量詞)',
      example: '這件衣服很好看。 (この服はとても似合っています/素敵です)',
      column: {
        title: '👔 洋服や用事を数える万能量詞「件 (ㄐㄧㄢˋ)」！',
        content: '• 上着・シャツ・コート・ワンピースなど、上半身または全身の服を数える定番量詞です（一件衣服＝服1着、一件外套＝上着1着）。※ズボンやスカートなど下半身は「一條 (ㄧˋ ㄊㄧㄠˊ)」を使います。<br>• 服だけでなく「事柄・用事」にも使われ、「一件事（1つの出来事・用件）」のように日常会話で超頻出です。'
      },
      createdAt: 1789143952000 // 2026/09/12 01:26
    },
    {
      traditional: '上',
      zhuyin: 'ㄕㄤˋ',
      pinyin: 'shàng',
      meaning: '入学する / 学校に通う / 登校する (上學 / 上大學)',
      example: '他今年要上大學了。 (彼は今年、大学に入学します/大学に進学します)',
      column: {
        title: '🎒 動詞「上」の多彩な意味（学校に通う・登校する・乗る）',
        content: '• <strong>上 (ㄕㄤˋ)</strong> は動詞として後ろに場所や目的を伴い「〜へ行く・通う」を表します。<br>• <strong>上學 (ㄕㄤˋ ㄒㄩㄝˊ)</strong>（学校へ通う・登校する）、<strong>上大學 (ㄕㄤˋ ㄉㄚˋ ㄒㄩㄝˊ)</strong>（大学に進学・入学する）、<strong>上班 (ㄕㄤˋ ㄅㄢ)</strong>（出勤する・仕事に行く）、<strong>上車 (ㄕㄤˋ ㄔㄜ)</strong>（車や電車に乗る）など、台湾の日常生活で最も使われる基本動詞の1つです。'
      },
      createdAt: 1789143951000 // 2026/09/12 01:26
    },
    {
      traditional: '找',
      zhuyin: 'ㄓㄠˇ',
      pinyin: 'zhǎo',
      meaning: '探す / 見つける / お釣りを渡す (找錢)',
      example: '你在找什麼？ (何を探しているのですか？)',
      column: {
        title: '🔍 「探す」と、台湾の買い物で必須の「お釣りを返す (找錢)」！',
        content: '• <strong>找 (ㄓㄠˇ)</strong> は「〜を探す」という動詞（找人＝人を探す、找手機＝スマホを探す）。<br>• また台湾のお店・夜市で絶対耳にするのが「お釣りを渡す」という意味の「<strong>找錢 (ㄓㄠˇ ㄑㄧㄢˊ)</strong>」です！例えば「找你五十塊（50元のお釣りです）」のように使われます。'
      },
      createdAt: 1789143950000 // 2026/09/12 01:26
    },
    {
      traditional: '看過',
      zhuyin: 'ㄎㄢˋ ㄍㄨㄛ˙',
  ...
  const STORAGE_KEY = 'taiwan_chinese_review_words_v13';
