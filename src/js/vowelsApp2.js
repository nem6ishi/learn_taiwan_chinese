import { VOWELS_STEP2_DATA, VOWELS_QUIZ_QUESTIONS_2 } from '../data/zhuyinVowels2.js';
...
function renderQuizQuestion(isUserAction = false) {
  if (currentQuizIndex >= VOWELS_QUIZ_QUESTIONS_2.length) {
    showQuizResult();
    return;
  }

  const q = VOWELS_QUIZ_QUESTIONS_2[currentQuizIndex];
  ...
  if (progressText) progressText.innerText = `第 ${currentQuizIndex + 1} / ${VOWELS_QUIZ_QUESTIONS_2.length} 問`;
  ...
  quizSection.innerHTML = `
    <div style="padding: 24px 0; text-align: center;">
      ...
      <p style="font-size: 1.25rem; color: var(--color-primary); font-weight: 700; margin-bottom: 20px;">
        正解数: ${quizScore} / ${VOWELS_QUIZ_QUESTIONS_2.length} 問
      </p>
